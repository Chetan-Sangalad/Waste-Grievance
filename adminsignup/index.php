    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li> <a href="admindash.php"><i class="fa fa-fw fa fa-question-circle"></i> dashboard</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </nav>
   ...
   if($total!=0) {
     ...
     echo "
           <tr class='panel panel'>
              ...
              <td> <a href = 'status.php?i=$result[Id]&s=$result[status]&m=$result[mobile] 'class='btn btn-success'>Status</a></td>
