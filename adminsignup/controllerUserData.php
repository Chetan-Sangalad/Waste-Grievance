...
if(isset($_POST['signup'])){
    ...
    // $e=$_POST['email'];
    // $p=$_POST['password'];
    // if($e=="admin123@gmail.com"&&$p==123456)
    // {
    //    header('Location: http://localhost/cscorner/waste-management-system-main/waste-management-system-main/adminlogin/index.php');
    // }
    //             // }else{
    ...
    if(isset($_POST['change-password'])){
        ...
        if($password !== $cpassword){
            ...
            $encpass = password_hash($password);//jdhjdhjdhjdhjhdjh  , PASSWORD_BCRYPT
