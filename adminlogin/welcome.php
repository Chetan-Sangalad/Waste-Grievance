 ...
 overflow: hidden;
  ...
  <a href="#about">About</a> -->
   ...
   <!-- <nav class="fixed-top">
    ...
    <br> -->
    <div class="container"  > <b><mark> YOUR COMPLAIN HISTORY </mark></b></div>
      <div class="container">     
...
function confirmDelete(){
    window.location.replace("http://localhost/cscorner/waste-management-system-main/waste-management-system-main/adminlogin/delete.php?i="+delId);
}
</script>
</body>
</html>
