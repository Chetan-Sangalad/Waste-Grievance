	...
	if( in_array($imageFileType,$extensions_arr) ){
	   ...
	   move_uploaded_file($image = $_FILES['file']['tmp_name'],$target_dir.$file);
    	...
    	if(mysqli_query($con,$sql)){
			$msg = '<div class = "alert alert-success"><span class="fa fa-check"> "Complain Registered Successfully!"</span><a href="http://localhost/cscorner/waste-management-system-main/waste-management-system-main/adminlogin/welcome.php"> view Complain </a></div>';
...
<body>
<!-- <div class="sidebar">
  <a href="http://localhost/cscorner/waste-management-system-main/waste-management-system-main/index.html"  class="fa fa-home"><strong> Home - <img src="Capture.PNG" alt="LOGO"heigth='30'width='30'class='logo1'>
 </strong></a>
  
</div><br> -->
	<div>
        <a href="http://localhost/cscorner/waste-management-system-main/waste-management-system-main/index.html"  class="fa fa-home"> Home </a>
    </div>
   <?php 
   $error ='';   
   ?>
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">          
					   <select class="form-control" id="location" name="location"required>
						   ...
						   <option class="form-control" >belman</option>
						   <option class="form-control" >karkala</option>
						   <option class="form-control" >padubidri</option>
						   <option class="form-control" >udupi</option>
					   </select>
					</div>
				  </div>
				<div class="form-group">
