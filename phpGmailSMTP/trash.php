...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($con, $sql)) {
        $msg = '<div class="alert alert-success"><span class="fa fa-check"> "Complain Registered Successfully!"</span><a href="http://localhost/EmailVerification/adminlogin/welcome.php"> view Complain </a></div>';
